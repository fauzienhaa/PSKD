...
if (isset($_POST["login"])) {
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM tbl_admin WHERE username = '$username'");
    $result2 = mysqli_query($mysqli, "SELECT * FROM tbl_user WHERE username = '$username'");
...
<body class="text-center">
    ...
    <div>
        <img style="width:50%; height:50%;" src="user/assets/logo.png" class="img-fluid">
    </div>
    ...
    <main class="form-signin">
        <form action="" method="POST">
            ...
            <div class="checkbox">
            Don't have an account? <a href="signup.php" style="text-decoration: none;" class="link-danger">Register Now</a>
            </div>
            <p class="mt-5 mb-3 text-muted">&copy; SMA Harapan Jaya</p>
        </form>
    </main>
